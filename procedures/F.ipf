...
/////////////////////////////
//(CCD��BG�̃f�[�^��)SPE�t�@�C����ǂݍ��݁Awave�̕��ϒl��o�����Ƃ�BG count��߂�
//wave����������΂��ׂĂ�wave�𕽋ς���
//���ς���ۂɁA���[100pnts�̃f�[�^�͎̂Ă�
Function GetBGcount()
...
//Cassidy Sin Fit//
///////////////////
Function CassidySinFit_kf(from,upto,min_limit,L,R,step,WindowName,index)		//���삳���CassidySinFit������ǂ݂₷���悤�ɕς�����́B
...
//main plot
	...
	//loop start						
		i = 0; j = -min_limit; k = 0
		for (i=0; i<pnts; i+=1)
			if (i-j<=min_limit)								//min_limit�̒��ɂ͋ɑ�_���Ȃ��̂ŃX�L�b�v
				continue
			endif
			if (difY[i]*difY[i+1]<=0 && difY[i]>=0)			//Xwave�̒l��pnt�̌������t��������Ȃ��Ǝg���Ȃ��B
				i += (invY[i]>invY[i+1])
				if (j == -min_limit)						//�P�߂�(originy��)�ɑ�_��pnt��j�Ɏ󂯓n��
					j = i
					continue
				endif
			//fitting start and define fit_invY
				CurveFit/Q/N/B=(i-j)/W=0/L=((i-j)*20) sin, invY[j,i]/X=X/D		//fitting start
				if (V_FitNumIters == 40)										//�������悭�킩��Ȃ��E�E�E			
					j = i														//����parameter��fitting�̎��s�񐔁H
					continue													//���܂�fitting�ł��Ȃ������炠����߂Ď��ɐi�ނ��Ă��ƁH
				endif															//
...
//////////////////////////
Function CassidySinFit_kf_test(from,upto,min_limit,L,R,step,WindowName,index)		//���삳���CassidySinFit������ǂ݂₷���悤�ɕς�����́B
	String WindowName, index
	Variable from, upto, min_limit, L, R, step
//define parameters
...
//Extract Wave Pnts//
/////////////////////
//srcWave��startPnt����endPnt�܂ł̃f�[�^��Wave����
