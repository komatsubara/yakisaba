...
#pragma version=6.23		// revised for Igor 6.23
#pragma IndependentModule= WM_GrfBrowser

// GraphBrowser.ipf
// Version 6.0, LH051121
// Version 6.01, Fixed two minor bugs, search for LH090609
// Version 6.23, JP, Moved Columns slider higher to avoid graph listbox overlap.
...
Function ckExpandProc(cba) : CheckBoxControl
	...
	switch( cba.eventCode )
		case 2: // mouse up
			...
			Variable leftWidth=  310*PanelResolution(cba.win)/ScreenResolution
...
Function MinPanelSize(winName,minwidth,minheight,r)
	...
	minwidth *= PanelResolution(winName)/ScreenResolution
	minheight *= PanelResolution(winName)/ScreenResolution
...
// search for "root:Packages:WMGrfBrowser:" and replace with "g."
...
Function NewGraphBrowserPanel(pname,x0,y0)
	...
	Slider slider0_F,pos={334,25},size={268,45},proc=ColSliderProc
