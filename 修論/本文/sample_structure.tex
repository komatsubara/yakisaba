...
下からnタイプGaAs基板、nタイプAlGaAsクラッド層、non-GaAs SCH層、活性層、non-GaAs　SCH層、p-InGaPエッチングストップ層、p-GaAs層、p-AlGaAsクラッド層、p-GaAsハイドープコンタクト層となっている。

活性層には(1)3周期量子井戸のエピウエハでは量子井戸層をInGaAs、バリア層をGaAsとしてGaAsに格子整合を行っている。InGaAsには圧縮歪がかかっている。(2)10周期量子井戸のエピウエハにおいては量子井戸層を同様にInGaAs、バリア層では歪補償のためにInGaPを用いている。
\begin{figure}[h]
	\centering
