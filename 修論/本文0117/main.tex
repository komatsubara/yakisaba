...
\def\noproofreadmark{\noproofreadmarktrue}
%============================the first modification ,,, always variable 
\def\addspan#1{%
 % \ifnoproofreadmark%
  % #1%
% \else%
...
%===============================the second mocification ... always variable
%\begin{comment}
\def\adsp02#1{%
 %\ifnoproofreadmark%
  % #1%
...
\def\adsppp#1{%
 %\ifnoproofreadmark%
   #1%
% \else%
  %\textcolor{red}{#1}% greenの修正は副査への説明の後
}
...
謝辞\\%その人の研究への貢献を謝辞の形で述べるところ
%\begin{comment}
　秋山英文教授には2年間の修士課程を通して物理への向き合い方だけではなく、人としての生き方を教えていただいたように思う。先生の下で過ごすことができたことを誇りに思う。


挟間優治助教授は居室での席が近かったことも合間って研究室生活を意義のあるものにしていただいたと感じている。物理に関する疑問からプログラムの書き方などなど多岐にわたるドバイスをいただいた。感謝申し上げる。Igor Proを利用した解析プログラムを作る上での貴重なアドバイスをいただいた。ILカーブ\delspppp{ノ}\adspppp{の}フィッティングプログラムや利得スイッチングのシミュレーションなどに繋がった。
...
先輩である中村考宏氏からはもっとも多くのことを学ばせていただいた。実験具体的な手法から半導体プロセスまでありとあらゆる場面で学ばせていただいた。

中前秀一氏にはレーザー動作に関する基礎物理の議論をしていただいたことが記憶に新しい。わからないことがあればいつでも議論をぶつけられるウェルカムな先輩であった。\delspppp{修論のアドバイス本当にありがとうございました。}\adspppp{本文作成、発表スライド作成においてたくさんのアドバイスといただき感謝申し上げる。}
...
また\adsp02{エピ成長やフォトリソグラフィ加工を行っていただいた}\delsp02{試料提供をしていただいた}NTT-AT社の職員の方々、およびオプトウェル社の職員の方々にも感謝の意を示したい。
